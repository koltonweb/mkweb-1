<header>
		...
		<div class="container" id="about">
			<div class="info" >
				...
				<div class="info-tabcontent fade">
					...
					<div class="photo">
						<img src="/portfolio/yoga/dist/img/massage.jpg" alt="Massage">
					</div>
				</div>
				<div class="info-tabcontent fade">
					<div class="description">
					...
					<div class="photo">
						<img src="/portfolio/yoga/dist/img/sunset.jpg" alt="sunset">
					</div>
				</div>
				<div class="info-tabcontent fade">
					<div class="description">
					...
					<div class="photo">
						<img src="/portfolio/yoga/dist/img/sunrise.jpg" alt="sunrise">
					</div>
				</div>
				<div class="info-tabcontent fade">
					<div class="description">
					...
					<div class="photo">
						<img src="/portfolio/yoga/dist/img/yoga.jpg" alt="yoga">
					</div>
				</div>
			</div>
			<div class="timer">
			...
			<div class="slider" id="photo">
				...
				<div class="wrap">
					...
					<div class="slider-item fade">
						<img src="/portfolio/yoga/dist/img/slider_1.jpg" alt="slider">
					</div>
					<div class="slider-item fade">
						<img src="/portfolio/yoga/dist/img/slider_2.jpg" alt="slider">
					</div>
					<div class="slider-item fade">
						<img src="/portfolio/yoga/dist/img/slider_3.jpg" alt="slider">
					</div>
					<div class="slider-item fade">
						<img src="/portfolio/yoga/dist/img/slider_4.jpg" alt="slider">
					</div>
			...
			<div class="contact" id="contacts">
				<div class="contact-img">
					<img src="/portfolio/yoga/dist/img/letter.png" alt="letter">
				</div>
			...
			<div class="container">
				<div class="social">
					<div class="social-block">
						<a href="#">
						<img src="/portfolio/yoga/dist/logo/twitter-logo-silhouette.svg" alt="">
						</a>
					</div>
					<div class="social-block">
						<a href="#">
						<img src="/portfolio/yoga/dist/logo/facebook-logo.svg" alt="">
						</a>
					</div>
					<div class="social-block">
						<a href="#">
						<img src="/portfolio/yoga/dist/logo/instagram-social-network-logo-of-photo-camera.svg" alt="">
						</a>
					</div>
					<div class="social-block">
						<a href="#">
						<img src="/portfolio/yoga/dist/logo/pinterest-logo.svg" alt="">
						</a>
					</div>
				</div>
			</div>
	...
	<script src="/portfolio/yoga/dist/js/script.js"></script>